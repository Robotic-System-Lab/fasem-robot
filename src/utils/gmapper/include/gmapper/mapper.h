...
private:
    ...
    rclcpp::Subscription<segmentation_interfaces::msg::SegmentationResult>::SharedPtr label_sub_;
    ...
    nlohmann::json labelJSON_;
    std::vector<int> labelReads_;
    std::vector<int> labelFails_;
    ...
    void labelCallback(const segmentation_interfaces::msg::SegmentationResult::SharedPtr msg);
