...
/// @file
/// @brief A library for streamlining frontier exploration.
...
public:
  ...
  /// @brief Checks if a rectangular robot footprint would collide with obstacles at a given position.
  /// @param position_x The x-coordinate of the robot center in world coordinates.
  /// @param position_y The y-coordinate of the robot center in world coordinates.
  /// @param robot_length The length of the robot (along x-axis) in meters.
  /// @param robot_width The width of the robot (along y-axis) in meters.
  /// @param safety_margin Additional safety margin in meters.
  /// @param map_data The occupancy grid map data.
  /// @return True if collision detected, false if safe.
  static bool checkRectangularFootprintCollision(
    double position_x, double position_y,
    double robot_length, double robot_width, 
    double safety_margin,
    const nav_msgs::msg::OccupancyGrid & map_data);

  /// @brief Checks if a frontier is safely reachable considering robot's rectangular footprint.
  /// @param frontier The frontier cell to check.
  /// @param robot_position Current robot position in world coordinates.
  /// @param robot_length The length of the robot in meters.
  /// @param robot_width The width of the robot in meters.
  /// @param safety_margin Additional safety margin in meters.
  /// @param map_data The occupancy grid map data.
  /// @return True if frontier is safely reachable, false otherwise.
