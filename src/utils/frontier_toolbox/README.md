...
~~~~~
rosdep install --from-paths src/utils/frontier_toolbox/frontier_exp_cpp/ src/utils/frontier_toolbox/nav_client_cpp/ src/utils/frontier_toolbox/robot_mapping/ --ignore-src --rosdistro humble --os=ubuntu:22.04 --skip-keys "opencv4 opencv2" --reinstall -y
~~~~~
