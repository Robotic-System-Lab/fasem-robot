...
///
/// PUBLISHES:
///     @param /scan (sensor_msgs::msg::LaserScan): Publishes intercepted narrow laserscan
///
/// SUBSCRIBES:
...
public:
  ...
  : Node("intercept")
  {
    ...
    // Publishers
    updated_scan_publisher_ = create_publisher<sensor_msgs::msg::LaserScan>("/fasem_scan", 10);
